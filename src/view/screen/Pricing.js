 function Pricing(){
    return(
      ...
      <p className="para">Simple and affordable price plans for you, your family.</p>
        ...
        <div className="row text-center align-items-end">
          ...
          <div className="col-lg-4 mb-5 mb-lg-0">
            <div className="bg-white p-5 rounded-lg shadow">
              ...
              <a href="/Booking" className="btn btn-primary btn-block p-2 shadow rounded-pill">Subscribe</a>
            </div>
          </div>
       ...
       <div className="col-lg-4 mb-5 mb-lg-0">
         <div className="bg-white p-5 rounded-lg shadow">
           <h1 className="h6 text-uppercase font-weight-bold mb-4">Basic</h1>
           <h2 className="h1 font-weight-bold">$1200<span className="text-small font-weight-normal ml-2">/ month</span></h2>
       ...
       <div className="col-lg-4 mb-5 mb-lg-0">
         <div className="bg-white p-5 rounded-lg shadow">
           <h1 className="h6 text-uppercase font-weight-bold mb-4">Pro</h1>
           <h2 className="h1 font-weight-bold">$1500<span className="text-small font-weight-normal ml-2">/ month</span></h2>
       ...
       <div className="col-lg-4">
         <div className="bg-white p-5 rounded-lg shadow">
           <h1 className="h6 text-uppercase font-weight-bold mb-4">Enterprise</h1>
           <h2 className="h1 font-weight-bold">$2000<span className="text-small font-weight-normal ml-2">/ month</span></h2>
